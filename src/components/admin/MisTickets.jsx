...
function MisTickets() {
  ...
  const handleVerDetalles = (id_tickets) => {
    navigate(`/ver-mas-tickets/${id_tickets}`);
  };
  ...
  return (
    <div>
      ...
      <div className="box_center container_header_misTickets">
                ...
                <div className="ticket-body">
                  ...
                  <div>
                    <strong>Asunto:</strong>
                      <p className='text_global'>
                        {ticket.asunto.length > 20 ? ticket.asunto.slice(0, 22) + '...' : ticket.asunto}
                      </p>
                  </div>
                  <div>
                    <strong>Descripción:</strong>
                      <p className='text_global'>
                        {ticket.descripcion.length > 25 ? ticket.descripcion.slice(0, 25) + '...' : ticket.descripcion}
                      </p>
                  </div>
                  <div>
