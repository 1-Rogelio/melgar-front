                ...
                <table className="table_ticketsTodos table table-bordered text">
                    ...
                    <tbody className='text-center'>
                        {tickets.map((ticket, index) => (
                            ...
                            <td >{ticket.Destinatario.nombre}</td>
                            <td >{ticket.asunto.length > 12 ? ticket.asunto.slice(0, 12) + '...' : ticket.asunto}</td>
                            <td >{ticket.descripcion.length > 12 ? ticket.descripcion.slice(0, 12) + '...' : ticket.descripcion}</td>
                            <td >{ticket.tipo}</td>
