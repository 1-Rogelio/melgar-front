                        ...
                        <div className="form_ver">
                            ...
                            <div className="container_detalles_ticket">
                                ...
                                <div className='columUno'>
                                    ...
                                    <div>
                                        <label className='text_global fechass'>Fecha de creación</label>
                                        <input className='form-control c_green_x text_global' value={ticket.fecha_creacion || 'fecha no disponible'} readOnly type="text" />
                                    </div>
                                </div>
                                ...
                                <div className='columDos'>
                                    <div>
                                        ...
                                        <textarea id="asunto" className='form-control text_paragraphs text_global' name="asunto" rows="6" value={ticket.asunto || 'no disponible'} readOnly></textarea>
                                    </div>
                                ...
                                <div className='columTres'>
                                    <div>
                                        <button onClick={() => setShowDialog(true)}>Responder</button>
                                    </div>
                                </div>
                            </div>
                        </div>
