...
<div>
        {/* --------------------------BOTON de usuario----------------------------------------- */}
          <div className=''>
            <img className="img-fluid avatar_auxiliar hover:shadow-8" src={img} alt={'Photo of '} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"/>
                ...
                <div className="offcanvas-body">
                  <div className='box_center'>
                    ...
                    <i className="pi pi-spin pi-cog configIcon"></i>
                      <NavLink to="/configuracion-auxiliar" className='configuracionLink text_d_n text_paragraphs_black'>
