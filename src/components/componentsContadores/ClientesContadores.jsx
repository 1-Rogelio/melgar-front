...
import HeaderContador from '../componentsContadores/header/HeaderContador';
import FormClientesContador from '../componentsContadores/FormClientesContador';



function ClientesContadores() {
...
<div>
        ...
        {isFormVisible && (
          <FormClientesContador onClose={handleCloseForm}/>
        )}
    </div>
...
export default ClientesContadores;
